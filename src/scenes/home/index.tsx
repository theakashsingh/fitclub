        ...
        <motion.div className="md:flex mx-auto w-5/6 items-center justify-center md:h-5/6" onViewportEnter={()=>setSelectedPage(SelectedPage.Home)}>
            ...
            <div className="z-10 mt-32 md:basis-3/5">
                ...
                <motion.div className="md:-mt-20" initial="hidden" whileInView="visible" viewport={{once:true, amount:0.5}} transition={{duration:0.5}} variants={{
                    ...
                    <p className="mt-8 text-sm">Transform your body, one workout at a time. Your fitness journey starts here.With our gym app, achieving your fitness goals is just a tap away. Elevate your workouts today!</p>
                </motion.div>
                {/* ACTION */}
