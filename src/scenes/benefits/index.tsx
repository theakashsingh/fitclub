    ...
    <section id="benefits" className="mx-auto min-h-full w-5/6 py-20">
        <motion.div onViewportEnter={()=>setSelectedPage(SelectedPage.Benefits)}>
            ...
            <motion.div className="md:my-5 md:w-3/5" initial="hidden" whileInView="visible" viewport={{once:true, amount:0.5}} transition={{duration:0.5}} variants={{
               ...
               <p className="my-5 text-sm">Experience a fitness haven with us – our gym offers a range of classes, nutritional guidance, and a friendly atmosphere where you can thrive and transform your life.</p>
            </motion.div>
            {/* BENEFITS */}
            <motion.div className="md:flex items-center justify-between gap-8 mt-5" initial="hidden" whileInView="visible" viewport={{once:true, amount:0.5}} variants={container} >
                {
                    benefitData.map((benefit:BenefitType)=>(
            ...
            <div className="mt-16 items-center justify-between gap-20 md:mt-28 md:flex">
                {/* GRAPHICS */}
                <img src={BenefitsPageGraphics} alt="benefits-page-graphics" className="mx-auto"/>
                {/* DESCRIPTION */}
                <div>
                    {/* TITLE */}
